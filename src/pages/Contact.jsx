    ...
    <>
      <section className="cs_page_header position-relative background-filled d-flex align-items-center justify-content-between" style={{ backgroundImage: "url('/assets/img/page_header_1.jpeg')" }}>
        <div className="container position-relative z-index-1">
          ...
          <h1 className="cs_fs_48 cs_fs_lg_36 text-white m-0">Contact</h1>
        </div>
      ...
      <section className="cs_pt_133 cs_pt_lg_75 cs_pb_133 cs_pb_lg_75">
        <div className="container">
          <div className="row">
            <div className="col-xl-7 col-lg-6">
              <div className="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_30">
                <div className="cs_section_heading_in">
                  <h3 className="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">Have any question?</h3>
                  <h2 className="cs_fs_48 cs_fs_lg_36 m-0">Write a Message</h2>
                </div>
              </div>
              <form className="row">
                <div className="col-lg-6">
                  <input className="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_35 bg-gray" type="text" placeholder="Your Name" />
                </div>
                <div className="col-lg-6">
                  <input className="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_35 bg-gray" type="email" placeholder="Email Address" />
                </div>
                <div className="col-lg-6">
                  <input className="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_35 bg-gray" type="text" placeholder="Phone" />
                </div>
                <div className="col-lg-6">
                  <input className="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_35 bg-gray" type="text" placeholder="Subject" />
                </div>
                <div className="col-lg-12">
                  <textarea className="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_40 bg-gray" placeholder="Message here ..." cols="35" rows="7"></textarea>
                </div>
                <div className="col-lg-12">
                  <button type="submit" className="cs_btn cs_style_1 cs_fs_16 cs_rounded_5 cs_pl_30 cs_pr_30 cs_pt_10 cs_pb_10 overflow-hidden"><span>Send A Message</span></button>
                </div>
              </form>
            </div>
            <div className="col-xl-5 col-lg-6">
              <div className="cs_pl_60 cs_pl_lg_0 cs_pt_lg_60">
                <div className="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_40">
                  <div className="cs_section_heading_in">
                    <h3 className="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10">Contact With Us</h3>
                    <h2 className="cs_fs_48 cs_fs_lg_36 cs_mb_20">Let’s work together</h2>
                    <p className="m-0">Providing legal advice, contract drafting, compliance assistance, intellectual property protection, and other legal support for businesses.</p>
                  </div>
                </div>
                <div className="d-flex align-items-center cs_mb_30">
                  ...
                  <div>
                    <p className="text-accent cs_mb_7">Have Any Question?</p>
                    <h2 className="m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">+ 070 4531 9507 </h2>
                  </div>
                </div>
                <div className="d-flex align-items-center cs_mb_30">
                  <div className="d-flex align-items-center justify-content-center cs_height_90 cs_width_90 cs_height_lg_80 cs_width_lg-80 cs_rounded_10 flex-none cs_mr_20 bg-accent">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div>
                    <p className="text-accent cs_mb_7">Address</p>
                    <h2 className="m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">Yewtree Cottage, Kings Pyon, HR4 8PZ</h2>
                  </div>
                </div>
              </div>
            </div>
